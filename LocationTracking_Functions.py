...
def tempTrackLocation(video_dict,tracking_params):
    """ 
    -------------------------------------------------------------------------------------
...
#    #try:
#    dlc_path = video_dict['dpath']+'\\0DLC_mobnet_100_nose_followpattern_211213Dec13shuffle1_100000.csv'
#  
#    #dlc_path = video_dict['dpath']+'\\0DLC_mobnet_100_Mix_rig1May12shuffle1_1030000.csv'
#    #dlc_path = video_dict['dpath']+'\\0DLC_mobnet_100_nose_trainNov5shuffle1_500000.csv'
...
#        dlc = pd.read_csv(dlc_path)
    ...
    try:
        ...
        try:
            ...
            dlc_path = video_dict['dpath']+'\\0DLC_mobnet_100_rig3_training_220614_m14r2Jun14shuffle1_1030000.csv'
            dlc = pd.read_csv(dlc_path)             
    ...
    #dlc = pd.read_csv(r"C:\Users\Lur Lab\Desktop\alitesting\0DLC_mobnet_100_nose_followpattern_211213Dec13shuffle1_100000.csv")
    X = (dlc.iloc[2::,1])
    Y = (dlc.iloc[2::,2])
    D = (dlc.iloc[2::,2])
...
#    df = ScaleDistance(video_dict, df=df, column='Distance_px')
   ...
   # new_data = pd.read_csv(r'D:\sn\snr1_3\12_57_02\My_WebCam\aaa.csv')
   # df = new_data
...
#    })
    ...
    #new_data = pd.read_csv(r"C:\Users\Lur Lab\Desktop\alitesting\0_tempLocationOutput.csv")
    
    df = pd.read_csv(video_dict['dpath']+'\\0_tempLocationOutput.csv')
